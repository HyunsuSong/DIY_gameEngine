...
void FileManager::GetData(RenderableObject* src, const char* obj, const char* dds)
{
	src->Texture = LoadDDS(obj);
	src->res = loadOBJ(dds, src->vertices, src->uvs, src->normals);
...
void FileManager::GetData(NonRenderObject* src, const char* obj, const char* dds)
{
	src->Texture = LoadDDS(obj);
	src->res = loadOBJ(dds, src->vertices, src->uvs, src->normals);
...
void FileManager::SetShader(const char* vs, const char* fs)
{
	VertexArrayID;
